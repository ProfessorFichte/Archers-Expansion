...
public class Sounds {
    public static final Identifier TRICK_SHOT_ID = new Identifier(MOD_ID, "trick_shot");
    public static SoundEvent TRICK_SHOT_EVENT= SoundEvent.of(TRICK_SHOT_ID);
    public static final Identifier SPECIAL_SHOT_ID = new Identifier(MOD_ID, "special_shot");
    public static SoundEvent SPECIAL_SHOT_EVENT= SoundEvent.of(SPECIAL_SHOT_ID);
    public static final Identifier CRYSTAL_ARROW_ID = new Identifier(MOD_ID, "enchanted_crystal_arrow_impact");
    public static SoundEvent CRYSTAL_ARROW_EVENT= SoundEvent.of(CRYSTAL_ARROW_ID);
    public static final Identifier PIN_DOWN_ID = new Identifier(MOD_ID, "pin_down");
    public static SoundEvent PIN_DOWN_EVENT= SoundEvent.of(PIN_DOWN_ID);
    public static final Identifier POINT_BLANK_SHOT_ID = new Identifier(MOD_ID, "point_blank_shot");
    public static SoundEvent POINT_BLANK_SHOT_EVENT= SoundEvent.of(POINT_BLANK_SHOT_ID);
    public static final Identifier POISON_CLOUD_ID = new Identifier(MOD_ID, "poison_cloud");
    public static SoundEvent POISON_CLOUD_EVENT= SoundEvent.of(POISON_CLOUD_ID);
    public static final Identifier INFILTRATOR_VANISH_ID = new Identifier(MOD_ID, "infiltrator_vanish");
