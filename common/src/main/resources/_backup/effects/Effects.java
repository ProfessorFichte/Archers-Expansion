...
public class Effects {
    ...
    public static class Entry {
        ...
        public Entry(String name, StatusEffect effect, String title, String description) {
    ...
    //DEAD EYE
    public static final Entry FAST_SHOT = new Entry("fast_shot",
            new CustomStatusEffect(StatusEffectCategory.BENEFICIAL, 0x805e4d),
            "Fast Shot", "Increases Range Haste with each shot.");
    public static final Entry CHOKING_GAS = new Entry("choking_gas",
            new ChokingGasEffect(StatusEffectCategory.HARMFUL, 0x805e4d),
            "Choking Gas Cloud", "Damages the target through poison and silences it. Damage is increased on bleeding entities.");
    public static final Entry DISABLING_SHOT = new Entry("disabling_shot",
            new DisablingShotEffect(StatusEffectCategory.HARMFUL, 0x805e4d),
            "Disabling Shot", "Slows the target and damages it overtime.");
    public static final Entry INFILTRATORS_ARROW = new Entry("infiltrators_arrow",
            new InfiltratorsArrowEffect(StatusEffectCategory.BENEFICIAL, 0x805e4d),
            "Infiltrator Vanish", "Invisible to enemies");
    public static final Entry INFILTRATORS_SPEED = new Entry("infiltrators_speed",
            new CustomStatusEffect(StatusEffectCategory.BENEFICIAL, 0x805e4d),
            "Infiltrator Speed", "Faster movement in stealth");

    //TUNDRA HUNTER
    public static final Entry FROZEN_SHOT = new Entry("frozen_shot",
            new CustomStatusEffect(StatusEffectCategory.BENEFICIAL, 0x99ccff),
            "Frozen Shot", "Your next shots stack the frosted effect on targets.");
    public static final Entry ENCHANTED_CRSYSTAL_ARROW = new Entry("enchanted_crystal_arrow",
            new CrystalArrowEffect(StatusEffectCategory.HARMFUL, 0x99ccff),
            "Crystal Arrow", "Stuns the target and gives the target frozen ticks.");
    public static final Entry FROZEN_PACT = new Entry("frozen_pact",
            new FrozenPactEffect(StatusEffectCategory.HARMFUL, 0x99ccff),
            "Frozen Pact", "Damages the targets according to their Frozen ticks and makes reduces their attack.");
    public static final Entry WINTERS_GRASP = new Entry("winters_grip",
            new WintersGraspEffect(StatusEffectCategory.HARMFUL, 0x805e4d),
            "Winters Grip", "Freezes nearby targets solid on death.");

    //WAR ARCHER
    public static final Entry SMOLDERING_ARROWS = new Entry("smoldering_arrows",
            new CustomStatusEffect(StatusEffectCategory.BENEFICIAL, 0x805e4d),
            "Smoldering Arrow", "Your next shot creates a small explosion near the target, damaging and burning entities around.");
    public static final Entry PIN_DOWN = new Entry("pin_down",
            new CustomStatusEffect(StatusEffectCategory.HARMFUL, 0x805e4d),
            "Pin Down", "The target cant move or jump during the effect.");
    ...
    public static void register (){
        ...
        SpellEvents.SPELL_CAST.register((args) -> {
            ...
            if (caster.hasStatusEffect(INFILTRATORS_ARROW.registryEntry)
